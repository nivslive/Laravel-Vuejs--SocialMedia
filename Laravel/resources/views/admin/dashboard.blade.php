...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="myTable">
                                    ...
                                    <tbody>
                                        @foreach($data['trends']['mostPopularSubjects']['data'] as $key => $mostPopularSubjects)
                                        <tr>
        ...
        <script src="
https://cdn.jsdelivr.net/npm/simple-datatables@7.2.0/dist/umd/simple-datatables.min.js
"></script>        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
        ...
        @vite(['resources/lib/admin/js/chart-area-demo.js'])
        @vite(['resources/lib/admin/js/chart-bar-demo.js'])
        @vite(['resources/lib/admin/js/chart-pie-demo.js'])
        @vite(['resources/lib/admin/js/datatables-demo.js'])
    </body>
</html>
