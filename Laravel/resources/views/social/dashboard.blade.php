...
<section id="content" style="opacity: 0">
 ...
 <div class="container-fluid" >
        ...
        <div class="row align-items-center py-2 px-lg-5">
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-flex align-items-end">
                    <h1 class="m-0 display-5 text-uppercase"><span class="text-primary">YORUS</span></h1>.club
                </a>
            </div>
    ...
    <div class="container-fluid bg-light pt-5 px-sm-3 px-md-5">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="font-weight-bold mb-4 b-radius">Categories</h4>
                <div class="d-flex flex-wrap m-n1">
                    <a href="" class="btn btn-sm btn-outline-secondary m-1">Politics</a>
                    <a href="" class="btn btn-sm btn-outline-secondary m-1">Business</a>
                    <a href="" class="btn btn-sm btn-outline-secondary m-1">Corporate</a>
