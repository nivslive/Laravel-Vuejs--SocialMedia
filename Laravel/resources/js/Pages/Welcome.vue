...
<template>
  ...
  <div>
    <section>
      ...
      <div class="bests">
        <a class="m-10" v-if="id[0].subjects[0]" :href="route('room', { chat: id[0].slug, subject: id[0].subjects[0].slug })">
          <div class="max-w-7xl mx-auto p-2 m-3 lg:p-8">
            <div class="flex">
              <div
                ...
                flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-indigo-500"
              >
                <div>
                  <p class="flex py-2" v-if="id[0].subjects[0].user">
                    <svg width="20px" style="margin-right: 5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  ...
                  <p class="flex"><svg width="20px" style="margin-right: 5px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path
                    d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 
                ...
                <g>
                  <g>
                    <path d="M428,41.534H30c-16.569,0-30,13.431-30,30v252c0,16.568,13.432,30,30,30h132.1l43.942,52.243
                      ...
                      s6.716-15,15-15h292.291c8.284,0,15,6.716,15,15C390.146,139.258,383.43,145.974,375.146,145.974z" fill="white"/>
                  </g>
                </g>
                </svg>
