...
<header class="flex w-100 flex-col justify-center items-unset pt-6 pb-4 px-5 border-b border-gray-200 m-auto">
  <!-- Image + name-->
  <div class="flex items-center"><a class="inline-flex items-start mr-3" href="#0"></a><img class="rounded-full" :src="data.user.profile_photo_url" width="48" height="48" alt="Lauren Marsano"/>
