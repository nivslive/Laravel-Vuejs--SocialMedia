...
<template>
    ...
    <section>
            ...
            <div class="popular-lasts-items" :key="key" v-for="(variation, key) in variations">
                <a :href="route('rooms', {slug: variation.slug})">
                    <button class="button-variation px-4 text-stone-600 flex items-center">
                        <h1 class="text-xl">{{ variation.title }}</h1> <b class="pl-1">Msgs:
                            {{  variation.allsums }}</b>
                    </button>
                </a>
            </div>
        ...
        <div class="bests">
            <h2 class="text-2xl font-bold leading-7 text-stone-50 sm:truncate sm:text-7xl sm:tracking-tight">{{  chat.title  }}</h2>
            <h2 class="text-2xl font-bold leading-7 text-stone-50 sm:truncate sm:text-2xl sm:tracking-tight"> {{  chat.description  }}</h2>
        </div>
