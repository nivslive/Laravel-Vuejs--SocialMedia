...
<template>
<form class="bg-gray-100 min-h-screen w-50 flex flex-col items-center justify-center">
   <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">

    <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
        <label for="title">Nome do novo Assunto</label>
        <input id="title" type="text" class="w-full px-0 text-sm text-gray-900 bg-white border-0 border-b-2 dark:bg-gray-800 dark:text-white dark:border-gray-400 focus:ring-0" placeholder="Enter a title..." required>
    </div>
    <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
